import { IonCol, IonContent, IonGrid, IonHeader, IonItem, IonLabel, IonModal, IonRow, IonTitle, IonToolbar, IonInput, IonButton, IonDatetime, IonText } from "@ionic/react";
                ...
                <IonGrid>
                    ...
                    <IonRow className="ion-text-center">
                        <IonCol>
                            <IonButton 
                                fill='clear'
                                onClick={props.onCancel}>Cancel</IonButton>
                        </IonCol>
                        <IonCol>
